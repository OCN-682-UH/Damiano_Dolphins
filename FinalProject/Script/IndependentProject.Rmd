...
- Click [HERE](https://github.com/OCN-682-UH/Damiano_Dolphins/blob/main/FinalProject/Output/dolphin_table.html) to see the whole table!
```{r echo=FALSE}
#view table
tableHW
```
---
![Alt text](../Photos/dtable.png){width=400px height=200px}
